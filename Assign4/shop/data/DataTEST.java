...
public class DataTEST extends TestCase {
	...
	public void testConstructorExceptionDirector() {try {
		Data.newVideo("Tests", 2002, null);
		Assert.fail();
	} catch (IllegalArgumentException e) {
	}
	try {
		Data.newVideo("wagwagwagawgwa", 2002, "");
		Assert.fail();
	} catch (IllegalArgumentException e) {
	}
	try {
		Data.newVideo("GWNAIOGNOIWANGWAO", 2002, "    ");
		Assert.fail();
	} catch (IllegalArgumentException e) {
	}
	}
